...
Public Class Consolidado_Monitoreos
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "SELECT * FROM CONSOLIDADO_MONITOREOS WHERE FECHA_GESTION BETWEEN '" & fechadesde & "' and '" & fechahasts & "'"
    ...
    Private Sub Consolidado_Monitoreos_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
