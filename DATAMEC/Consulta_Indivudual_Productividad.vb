...
Public Class Consulta_Indivudual_Productividad
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "SELECT * FROM PRODUCTIVIDAD WHERE FECHA_GESTION='" & fecha & "' AND USUARIO='" & usu & "'"
    ...
    Private Sub cargar_registros2(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim usu As String = TextBox1.Text
        Dim consulta As String = "SELECT PROCESO,COUNT(CUENTA) AS 'TOTAL' FROM PRODUCTIVIDAD WHERE FECHA_GESTION='" & fecha & "' AND USUARIO='" & usu & "' GROUP BY PROCESO"
        Dim dttable As New DataTable
        Dim bedit As Boolean
