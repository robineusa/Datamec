...
Public Class Consolidado_Hallazgos_por_Proceso
    ...
    Private Sub Form7_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        gestion = "SELECT PROCESO FROM CONSOLIDADO_HALLAZGOS GROUP BY PROCESO"
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "SELECT * FROM CONSOLIDADO_HALLAZGOS WHERE PROCESO ='" & ges & "' AND FECHA_HALLAZGO between '" & fechadesde & "' and  '" & fechahasts & "'"
