Module Module1
    ...
    Public CUENTA_CORREO As Double
    Public NOMBRE_ASESOR As String
    Public CEDULA_ASESOR As Double
    Public ALIADO_ASESOR As String
    Public OPERACION_ASESOR As String
    Public NOTA_ASESOR As Double
    Public FECHA_CORREO As String
    Public PROCESO As String
    Public ETIQUETA_LLAMADA As String
    Public OBSERVACIONES_ASESOR As String
    Public PROCESO_GESTION As String
    Public FRENTE_GESTION As String
    Public REGISTRO_NOVO_GENERAL As Double
End Module
