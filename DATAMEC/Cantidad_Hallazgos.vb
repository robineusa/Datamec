...
Public Class Cantidad_Hallazgos
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        ...
        Dim consulta As String = "SELECT PROCESO, COUNT(CUENTA) AS 'CANTIDAD' FROM CONSOLIDADO_HALLAZGOS WHERE FECHA_HALLAZGO BETWEEN '" & fechaini & "' and '" & fechafin & "' GROUP BY PROCESO"
