...
Public Class Cantidad_Monitoreos
    ...
    Private Sub cargar_registros(ByVal sql As String, ByVal dv As DataGridView)
        Dim fechaini As String = DateTimePicker1.Value
        Dim fechafin As String = DateTimePicker2.Value

        Dim consulta As String = "SELECT PROCESO, COUNT(CUENTA) AS 'CANTIDAD' FROM CONSOLIDADO_MONITOREOS WHERE FECHA_GESTION BETWEEN '" & fechaini & "' and '" & fechafin & "' GROUP BY PROCESO"
