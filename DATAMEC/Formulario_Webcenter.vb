...
Public Class Formulario_Webcenter

    Private Sub Formulario_Webcenter_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub ComboBox10_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox10.SelectedIndexChanged
        ...
        c2 = "SELECT SUBPROCESOS.DESCRIPCION FROM (SUBPROCESOS INNER JOIN PROCESOS ON SUBPROCESOS.ID_PROCESO = PROCESOS.ID_PROCESO) INNER JOIN MACROPROCESOS ON PROCESOS.ID_MACROPROCESO = MACROPROCESOS.ID_MACROPROCESO WHERE (((PROCESOS.DESCRIPCION)='" & nombre_proceso & "') AND ((MACROPROCESOS.ID_MACROPROCESO)=2))"
    ...
    Private Sub ComboBox11_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles ComboBox11.SelectedIndexChanged
        ...
        c2 = "SELECT SUBITEM.DESCRIPCION FROM ((SUBPROCESOS INNER JOIN PROCESOS ON SUBPROCESOS.ID_PROCESO = PROCESOS.ID_PROCESO) INNER JOIN MACROPROCESOS ON PROCESOS.ID_MACROPROCESO = MACROPROCESOS.ID_MACROPROCESO) INNER JOIN SUBITEM ON SUBPROCESOS.ID_SUBPROCESO = SUBITEM.ID_SUBPROCESO WHERE (((MACROPROCESOS.ID_MACROPROCESO)=2) AND ((PROCESOS.DESCRIPCION)='" & nombre_proceso & "') AND ((SUBPROCESOS.DESCRIPCION)='" & nombre_subproceso & "'))"
        Dim adaptadorsql2 As New SqlDataAdapter(c2, New SqlConnection(coneccion))
        adaptadorsql2.Fill(dt2)
